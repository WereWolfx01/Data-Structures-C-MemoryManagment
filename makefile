...
all: ds_memory graph main a1_create a1_malloc a1_view a1_write a1_read ds_array create_array show_array insert replace_array read_elements delete_array swap_array find_array ds_list create_list show_list replace_list insert_list read_list_elements delete_list swap_list find_list
...
swap_list: $(HEADER3) $(HEADER2) $(HEADER) swap_list.c
	$(CC) $(CFLAGS) swap_list.c ds_list.o ds_memory.o -o swap_list

find_list: $(HEADER3) $(HEADER2) $(HEADER) find_list.c
	$(CC) $(CFLAGS) find_list.c ds_list.o ds_memory.o -o find_list

graph: $(HEADER3) $(HEADER2) $(HEADER) graph.c
	$(CC) $(CFLAGS) graph.c ds_list.c ds_memory.o -o graph
